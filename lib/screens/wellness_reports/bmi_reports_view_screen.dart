              ...
              itemBuilder: (BuildContext context, int index) {
                final Map<String, dynamic> documentData =
                    documents[index].data()! as Map<String, dynamic>;
                     DateTime date = DateTime.parse(documentData['date'].toDate().toString());
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Text("Measurement Date : " + DateFormat('dd/MM/yyyy').format(date),
                            style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 2, 90, 8))),                           
