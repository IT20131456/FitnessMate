                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          icon: Icon(
                              Icons.calculate), // Add the icon to the button
                          label: Text(
                            'Calculate',
                            style: TextStyle(
                              fontSize: 18,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          child: Row(
                            ...
                            children: [
                              Icon(Icons.save), // Add the save icon
                              SizedBox(
                                  width:
                          ...
                          onPressed: () async {
                            if (_formKey.currentState?.validate() == true) {
                              ...
                              int age = int.parse(_bmireportAgeController.text);
                              int height =
                                  int.parse(_bmireportHeightController.text);
                              int weight =
                                  int.parse(_bmireportWeightController.text);
